...
export class SvgTemplateManager {
    ...
    public static addTemplate(templateName: string, template: string, override: boolean): void {
        const imageTemplates = SvgTemplateManager._imageTemplates;
     ...
     * @returns 
     */
    public static getElement(templateName: string, text: string = '', color: string = '#1A73AA', secondaryColor: string = 'white', scale: number = 1): HTMLElement {
     ...
     */
    private static readonly _imageTemplates: { [key: string]: string } = {
        /**********************
         * Marker templates
         **********************/
     ...
     */
    public static _applyStyle(templateName: string, text: string = '', color: string = '#1A73AA', secondaryColor: string = 'white', scale: number = 1): string {
        color = color || "#1A73AA";
        secondaryColor = secondaryColor || "#fff";
        let t = SvgTemplateManager.getTemplate(templateName, scale);
